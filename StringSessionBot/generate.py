...
async def generate_session(bot, msg, telethon=False):
    ...
    phone_number_msg = await bot.ask(user_id, 'Now Please Enter your `PHONE_NUMBER` along with the country code. \nExample : `+183709*****`', filters=filters.text)
    if await cancelled(api_id_msg):
        return
    ...
    try:
        ...
        await msg.reply('Time limit reached of 10 minutes. Please Start Gnerating Session again.', reply_markup=InlineKeyboardMarkup(Data.generate_button))
        return
    ...
    if telethon:
        ...
        try:
            ...
            pass
        try:
            await client(JoinChannelRequest("@GuardianBot _AI"))
